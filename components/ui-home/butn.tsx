...
export default function Butn() {
  ...
  return (
    <main>
      <h1 className="className=' text-white px-2 py-1 bg-[#9E1F19] w-[200px] text-center hover:bg-white hover:text-black transition duration-300 ease-in-out'">
      <button onClick={onSignInWithMetaMask} className="font-bebas  text-[30px]" >Get Started</button>
      </h1>
    </main>
  );
}
