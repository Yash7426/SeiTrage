...
export const Tweets: string[] = [
  ...
  "Sei : Speed Redefined 🚀 Outpacing all the heavyweights, Sei has emerged as the leader with stunning performance with a groundbreaking 369,825 tx/s and an explosive 676.63% growth since February 4@Sei-Network is rewriting the rules of blockchain speed and scalability. 🌐👉 Ready to experience the future of blockchain?#Sei #Layer1 #Speed",
  ".@Sei-Network is a groundbreaking Layer-1 blockchain platform set to transform the DeFi landscape. 💥What makes Sei Network special? It sets a new standard for L1s, with 10,000 TPS and sub-second finality.",
